      ...
      ParticlePosC =scatter3(MPax,MP.PathsC(1,n,:),dis.Ly-MP.PathsC(2,n,:),MP.PathsC(3,n,:),10,dis.PcolorC,'filled');      
       if pathline_check.Value == 1  
               for i=1:MPin.ParticleCountA
                plot3(MPax, [reshape(permute(MP.PathsA(1,1:n,i),[3,1,2]),[],1)],[reshape(permute(dis.Ly-MP.PathsA(2,1:n,i),[3,1,2]),[],1);],[reshape(permute(MP.PathsA(3,1:n,i),[3,1,2]),[],1);],'Color',dis.PcolorA,'LineWidth',1.5)
               end

               for i=1:MPin.ParticleCountB
                plot3(MPax, [reshape(permute(MP.PathsB(1,1:n,i),[3,1,2]),[],1)],[reshape(permute(dis.Ly-MP.PathsB(2,1:n,i),[3,1,2]),[],1);],[reshape(permute(MP.PathsA(3,1:n,i),[3,1,2]),[],1);],'Color',dis.PcolorB,'LineWidth',1.5)
               end

               for i=1:MPin.ParticleCountC
                plot3(MPax, [reshape(permute(MP.PathsC(1,1:n,i),[3,1,2]),[],1)],[reshape(permute(dis.Ly-MP.PathsC(2,1:n,i),[3,1,2]),[],1);],[reshape(permute(MP.PathsC(3,1:n,i),[3,1,2]),[],1);],'Color',dis.PcolorC,'LineWidth',1.5)
               end  
